...
function AdminLayout() {
  ...
  const navLinkClass = ({ isActive }) =>
    `flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 ${
      isActive
        ? 'bg-white text-accent shadow-md border border-accent-light'
  ...
  return (
    <div className="min-h-screen bg-surface-alt flex">
      {/* Sidebar Desktop */}
      <aside className="w-64 bg-gradient-to-b from-accent to-purple-600 text-white flex flex-col shadow-custom-lg hidden lg:flex">
        <div className="px-6 py-6 border-b border-white/10">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-white/70 mt-0.5">Panel Admin</p>
            </div>
          </Link>
        </div>
        ...
        <nav className="flex-1 px-4 py-5 space-y-1 overflow-y-auto">
          ...
          <p className="px-4 pt-4 text-[10px] uppercase font-bold text-white/50 tracking-wider mb-2">Ventas & Clientes</p>
          ...
          <NavLink to="/admin/ventas" className={navLinkClass}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <path d="M7 5h10l4 5v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-9l4-5z"></path>
            </svg>
            Ventas
          </NavLink>
          <NavLink to="/admin/facturas" className={navLinkClass}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <NavLink to="/admin/citas" className={navLinkClass}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <NavLink to="/admin/pqr" className={navLinkClass}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <p className="px-4 pt-4 text-[10px] uppercase font-bold text-white/50 tracking-wider mb-2">Gestión</p>
          ...
          <NavLink to="/admin/servicios" className={navLinkClass}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <NavLink to="/admin/perfil" className={navLinkClass}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <header className="bg-white/80 backdrop-blur-lg border-b border-gray-100 shadow-custom-sm sticky top-0 z-20">
          <div className="px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Link to="/" className="lg:hidden w-10 h-10 rounded-xl bg-gradient-to-br from-accent to-purple-500 flex items-center justify-center text-white shadow-md">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path>
                </svg>
              </Link>
              <div>
                <h2 className="text-lg font-bold text-text-heading leading-none">Panel de Administración</h2>
                <p className="text-xs text-gray-500 mt-0.5">Gestión de usuarios, productos, servicios y pedidos</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
